module IRB
  module Env
    ...
    load '~/.irb/env/bundler.rb'
    load '~/.irb/env/reloader.rb'
    load '~/.irb/env/rails.rb'
    load '~/.irb/env/active_record.rb'
    load '~/.irb/env/mongoid.rb'
    load '~/.irb/env/copycopter_client.rb'
    load '~/.irb/env/rails.rb'
    load '~/.irb/env/reloader.rb'
